...
public class TestDoap {
    ...
    public void testMergingDifferentFiles() {
        ...
        // assertTrue(Utilities.compareRDFFiles(file2Path, file1Path), "The generated
        // file should be the same as the original.");
        // assertTrue(Utilities.compareRDFFiles(mergedFilePath, file1Path), "Merged file
        // should be the same as the generated file.");
    ...
    public void testCreateRdfFromN3() {
        ...
        // assertTrue(Utilities.compareRDFFiles(file1Path, file3Path), "The generated
        // file should be the same as the original.");
